...
namespace MediaWall
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DirectoryContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DirectoryDatabase")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(name: "directory", template: "{controller=Directory}/{action=GetDirectory}/{WhatDirectory?}/{SearchTerm?}");
